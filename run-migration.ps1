# run-migration.ps1
# Скрипт для выполнения миграций в file-service
...
Write-Host "Database Migrations for file-service" -ForegroundColor Cyan

if (!(Test-Path "package.json")) {
    Write-Host "Error: package.json not found. Make sure you are in file-service directory" -ForegroundColor Red
    exit 1
}
