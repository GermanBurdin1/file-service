...
# Скрипт для генерации новых миграций в file-service
...
if (!(Test-Path "package.json")) {
    Write-Host "❌ Ошибка: package.json не найден. Убедитесь, что вы в директории file-service" -ForegroundColor Red
    exit 1
}
